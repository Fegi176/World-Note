...
allowed_root={'README.md','CONTRIBUTING.md','CHANGELOG.md','AGENTS.md','IMPLEMENTATION_STATUS.md','NodeNote_Worldbuilder_Codex_Prompt.md','.gitignore','.gitattributes','settings.gradle.kts','build.gradle.kts','gradle.properties','gradlew','gradlew.bat'}
