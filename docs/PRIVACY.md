...
No account, subscription, advertising, analytics, cloud service, runtime web fonts, or background network access. The manifest requests no INTERNET or broad storage permissions. Runtime dependencies and sample artwork are bundled/local.
